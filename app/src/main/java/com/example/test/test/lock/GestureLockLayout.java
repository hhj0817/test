package com.example.test.test.lock;
...
public class GestureLockLayout extends RelativeLayout {
    ...
    //是否显示图案路径
    private boolean isPatternShow = true;
    ...
    private void setLockViewParams(ILockView lockView) {
        ...
        for (int i = 0; i < mDotCount * mDotCount; i++) {
            ...
            LayoutParams lockerParams = new LayoutParams(mLockViewWidth, mLockViewWidth);
    ...
    public void setPatternShow(boolean show){
        isPatternShow = show;
    }
